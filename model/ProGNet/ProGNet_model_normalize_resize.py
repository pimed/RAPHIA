...
def Step3(input_file_name,outputDir, standardHist):
    ...
    def piecewise_histogram_normalize (test_flag, input_file_name, output_dir, standard_hist, mask_dir=None, write_to_disk=True ):
        ...
        nyul_normalize(input_file_name, output_dir, standard_hist,mask_dir=None, write_to_disk=True)
        return


    def nyul_normalize(input_file_name,  output_dir, standard_hist,mask_dir=None, write_to_disk=True):
        input_files = [None]*1
        input_files[0] = input_file_name
    ...
    piecewise_histogram_normalize (test_flag, input_file_name, output_dir, standardHist )
...
def ProGNet(inputFile, outputDir, standardHist, modelPath):
    Step3(inputFile, outputDir , standardHist)
